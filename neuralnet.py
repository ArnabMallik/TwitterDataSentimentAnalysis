...
def extract_features(tweets, batch_size=500, test_file=True, feat_type='frequency'):
...
if __name__ == '__main__':
    ...
    for j in range(nb_epochs):
        ...
        print('\nEpoch: '+ str(j + 1)+' val_acc: '+str(val_acc))
        #print('\nEpoch: %d, val_acc:%.4f') % (j + 1, val_acc)
        random.shuffle(train_tweets)
        if val_acc > best_val_acc:
            print ('Accuracy improved from '+ str(best_val_acc) +' to '+ str(val_acc) +', saving model')
